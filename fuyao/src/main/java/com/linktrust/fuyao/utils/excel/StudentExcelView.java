...
public class StudentExcelView extends AbstractExcelView {  
	...
	public StudentExcelView(List<Map<String,Object>> datalist,List<Map<String,Object>> columnlist) {
    ...
    protected void buildExcelDocument(Map<String, Object> obj,  
		...
		if (dataList != null && columnList != null) {
			...
			String filename = "学生账号_"+System.currentTimeMillis()/1000+".xls";//设置下载时客户端Excel的名称     
